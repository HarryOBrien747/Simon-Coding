...
program cluster_bhtree_leapfrog
  ...
  real(dp), parameter :: theta = 0.2_dp            ! BH opening angle
  real(dp), parameter :: theta_force = 0.2_dp       ! force accuracy
  real(dp), parameter :: theta_energy = 0.1_dp   ! stricter energy diagnostic
...
contains
  ...
  integer, parameter :: nbin = nint((mmax - mmin)/dm)   ! 19 bins 
  integer :: counts(nbin)
  integer :: i, b
  ...
  ! optional: print a few top bins to screen
